...
<body>
            ...
            <?php if ($result) :
                while ($rows = mysqli_fetch_assoc($result)) : ?>
                    <tr>
                        ...
                        <th><a href="?product_id=<?= $rows['product_id'] ?>" class="btn btn-danger delete-btn" onclick="return confirm('Bạn có muốn xóa sản phẩm này?')">Xóa Sản phẩm</a></th>
                    </tr>
                <?php endwhile; ?>
            <?php endif ?>
        </table>
    ...
    <script>
        ...
        //         e.preventDefault();
        //         let res = confirm("bạn muốn xóa sản phẩm này");
        //         if(res){
